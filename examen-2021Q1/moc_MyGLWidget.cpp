...
QT_MOC_LITERAL(1, 11, 13), // "toggleCamera1"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 13), // "toggleCamera2"
QT_MOC_LITERAL(4, 40, 18) // "canviaCameraToggle"

    },
    "MyGLWidget\0toggleCamera1\0\0toggleCamera2\0"
    "canviaCameraToggle"
};
...
void MyGLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->toggleCamera1(); break;
        case 1: _t->toggleCamera2(); break;
        case 2: _t->canviaCameraToggle(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyGLWidget::toggleCamera1)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MyGLWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyGLWidget::toggleCamera2)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MyGLWidget::toggleCamera1()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void MyGLWidget::toggleCamera2()
{
