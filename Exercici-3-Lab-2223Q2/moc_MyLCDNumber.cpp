...
QT_MOC_LITERAL(1, 12, 9), // "emitValue"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 16), // "emitRunningState"
QT_MOC_LITERAL(4, 40, 15), // "startCronometre"
QT_MOC_LITERAL(5, 56, 14), // "stopCronometre"
QT_MOC_LITERAL(6, 71, 17), // "restartCronometre"
QT_MOC_LITERAL(7, 89, 16) // "comptaMilisegons"

    },
    "MyLCDNumber\0emitValue\0\0emitRunningState\0"
    "startCronometre\0stopCronometre\0"
    "restartCronometre\0comptaMilisegons"
};
...
void MyLCDNumber::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->emitValue((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: _t->emitRunningState((*reinterpret_cast< const bool(*)>(_a[1]))); break;
        case 2: _t->startCronometre(); break;
        case 3: _t->stopCronometre(); break;
        case 4: _t->restartCronometre(); break;
        case 5: _t->comptaMilisegons(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (MyLCDNumber::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyLCDNumber::emitValue)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MyLCDNumber::*)(const bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyLCDNumber::emitRunningState)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MyLCDNumber::emitValue(const QString & _t1)
{
...
// SIGNAL 1
void MyLCDNumber::emitRunningState(const bool _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
