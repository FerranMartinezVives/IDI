...
void MyGLWidget::keyPressEvent(QKeyEvent* event) {
  ...
  switch (event->key()) {
    case Qt::Key_F :
      tipusFocus = not tipusFocus;
      glUniform1i(tipusFocusLoc, tipusFocus);
      break;
    case Qt::Key_A :
      if (colorFocus == glm::vec3(0.8, 0.8, 0.8)) colorFocus = glm::vec3(0, 0, 0);
...
void MyGLWidget::carregaShaders()
{
  ...
  tipusFocusLoc = glGetUniformLocation(program->programId(), "tipusFocus");
}